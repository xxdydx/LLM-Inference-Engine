...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_METRICSRESPONSE']._serialized_end=535
  _globals['_INFERENCESERVICE']._serialized_start=538
  _globals['_INFERENCESERVICE']._serialized_end=754
